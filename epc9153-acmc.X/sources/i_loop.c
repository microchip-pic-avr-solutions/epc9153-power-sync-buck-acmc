...
{
    0x4D8B, // Coefficient B0 will be multiplied with error input e(n-0)
    0x07DD, // Coefficient B1 will be multiplied with error input e(n-1)
    0xBA53  // Coefficient B2 will be multiplied with error input e(n-2)
};

// Coefficient normalization factors
volatile int16_t i_loop_pre_scaler = 3;
volatile int16_t i_loop_post_shift_A = 0;
volatile int16_t i_loop_post_shift_B = 6;
