...
;  Author:      Yuanzhe
;  Date/Time:   5/15/2020 3:13:08 PM
; **********************************************************************************
;  1P1Z Control Library File (Dual Bitshift-Scaliing Mode)
; **********************************************************************************
...
;------------------------------------------------------------------------------
	...
	.global _v_loop_only_Update
_v_loop_only_Update:    ; provide global scope to routine
...
; Read data from input source and calculate error input to transfer function
	...
	mov [w0 + #offPtrControlError], w2    ; load pointer address of target buffer of most recent error value from data structure
...
;------------------------------------------------------------------------------
; Global function declaration _v_loop_only_Reset
; This function clears control and error histories enforcing a reset
;------------------------------------------------------------------------------
	
	.global _v_loop_only_Reset
_v_loop_only_Reset:
...
;------------------------------------------------------------------------------
; Global function declaration _v_loop_only_Precharge
; This function loads user-defined default values into control and error histories
;------------------------------------------------------------------------------
	
	.global _v_loop_only_Precharge
_v_loop_only_Precharge:
