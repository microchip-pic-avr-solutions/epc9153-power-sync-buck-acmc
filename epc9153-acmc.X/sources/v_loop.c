 ...
 * *********************************************************************************
 * User:                Yuanzhe
 * Date/Time:           5/27/2020 10:30:28 AM
 * ********************************************************************************/
...
{
    0x4542, // Coefficient A1 will be multiplied with controller output u(n-1)
    0xFABF  // Coefficient A2 will be multiplied with controller output u(n-2)
};

volatile fractional v_loop_BCoefficients [3] =
{
    0x45C2, // Coefficient B0 will be multiplied with error input e(n-0)
    0x00DF, // Coefficient B1 will be multiplied with error input e(n-1)
    0xBB1E  // Coefficient B2 will be multiplied with error input e(n-2)
};
