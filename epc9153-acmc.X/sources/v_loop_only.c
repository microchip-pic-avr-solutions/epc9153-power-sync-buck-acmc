...
{
    0x60E4, // Coefficient B0 will be multiplied with error input e(n-0)
    0x60E4  // Coefficient B1 will be multiplied with error input e(n-1)
};

// Coefficient normalization factors
volatile int16_t v_loop_only_pre_scaler = 3;
volatile int16_t v_loop_only_post_shift_A = 0;
volatile int16_t v_loop_only_post_shift_B = 12;
